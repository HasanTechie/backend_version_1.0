...
//        $url = 'https://www.baglionihotels.com/branches/baglioni-hotel-regina-rome/';
//        $client = new Client();
//        $crawler = $client->request('GET', $url);
//        $form = $crawler->filter("#nd-booking-custom")->form();
//        $form['destination'] = 50977;
//        $form['nd_booking_archive_form_date_range_from'] = date("Y-m-d", strtotime("+25 day", strtotime(date("Y-m-d"))));
//        $form['nd_booking_archive_form_date_range_to'] = date("Y-m-d", strtotime("+26 day", strtotime(date("Y-m-d"))));
//        $form['nd_booking_archive_form_guests'] = 1;
//        $form['nd_booking_archive_form_rooms'] = 1;
//        $form['special_code'] = null;
////        dd($form);
//
//        $crawler = $client->submit($form);
//        dd($crawler->getUri());
