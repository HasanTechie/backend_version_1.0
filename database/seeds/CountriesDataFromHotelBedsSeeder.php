...
class CountriesDataFromHotelBedsSeeder extends Seeder
{
    /**
...
// Signature is generated by SHA256 (Api-Key + Secret + Timestamp (in seconds))
        ...
        $endpoint = "https://api.test.hotelbeds.com/hotel-content-api/1.0/locations/countries?fields=all&language=ITA&from=1&to=250";
