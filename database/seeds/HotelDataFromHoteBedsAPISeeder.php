...
// Your API Key and secret
        $apiKey = "gj35y5vtnqc38znqmmmrad3k"; //my account-> pysddg44tcryeh6q4gfskn5h
        $Secret = "jURav9VUbz"; // my account-> qC6mp7f5tT
//        $username = "maxbiocca";
//        $password = "bebrave4soliDPS";

        $apiArray = Array(
            array("apiKey1", "secretKey1"),
            array("apiKey2", "secretKey2"),
            array("apiKey3", "secretKey3"),
            array("apiKey4", "secretKey4")
        );
        ...
        for ($j = 1; $j < 175; $j++) {
            ...
            $signature = hash("sha256", $apiArray[$k][0] . $apiArray[$k][0] . time());
            ...
            echo $endpoint . ' key:' . $apiArray[$k][0] . ' secret:' . $apiArray[$k][1] . '</br>';
        }
...
//                        echo "Server JSON Response:" . $resp;
        ...
        foreach ($response->hotels as $instance) {
            DB::table('hotelbeds_api_content')->insert([
