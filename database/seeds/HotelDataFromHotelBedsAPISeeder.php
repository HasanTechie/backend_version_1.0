...
class HotelDataFromHotelBedsAPISeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($j = 1; $j < 229; $j++) {
            ...
            $signature = hash("sha256", $apiArray[0][0] . $apiArray[0][1] . time());
            ...
            echo $endpoint . ' key:' . $apiArray[0][0] . ' secret:' . $apiArray[0][1] . "\n <br/>";
            ...
            if ($second >= 180000) {
                ...
                try {
                    ...
                    curl_setopt_array($curl, array(
                        ...
                        CURLOPT_HTTPHEADER => ['Accept:application/json', 'Api-key:' . $apiArray[0][0] . '', 'X-Signature:' . $signature . '']
                    ));
