            ...
            if (!DB::table('trends')->where([
                ...
                try {
                    ...
                    if (isset($data)) {
                        ...
                        echo ++$i . ' Completed :' . $j . ' (' . $keyword->keyword . ') ' . Carbon\Carbon::now()->toDateTimeString() . "\n";
                    }
                    ...
                    if (!empty($ex)) {
                        $data = null;
                        $gt = null;
                        echo ++$i . ' Incomplete :' . $j . ' (' . $keyword->keyword . ')  ' . Carbon\Carbon::now()->toDateTimeString() . "\n";
//                            echo $ex . "\n";

                    }
                }
            } else {
                echo ++$i . ' Exists :' . $j . ' (' . $keyword->keyword . ') ' . Carbon\Carbon::now()->toDateTimeString() . "\n";
            }
//        }
        }
