...
class CreateRoomsPricesHotelBaglioniTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rooms_prices_hotel_baglioni', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rooms_prices_hotel_baglioni');
    }
}
